...
cap = cv2.VideoCapture("C:\\Users\\ziad2\\Desktop\\Video-Processing-main\\test3.mp4")
...
def read_from_camera_parallel(age_net, gender_net, face_cascade):
...
if __name__ == "__main__":
    ...
    read_from_camera_parallel(age_net, gender_net, face_cascade)